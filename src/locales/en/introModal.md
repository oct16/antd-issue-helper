Maintaining open source projects is hard work. As a free and open source project, TimeCat also has limited maintainer bandwidth. That means the only way to ensure the project's sustainability is to:
